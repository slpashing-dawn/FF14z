        ...
        const tracks = [ 
            ...
            { 
                title: "길이요 진리요 생명이신", 
                sub: "- 가톨릭성가 34번(시프 T. 세크렛)", 
                ytId: "6wwbH3u1UAE" // 예시: 칠흑 테마 유튜브 ID
            }
        ...
        // 모그레터 랜덤 편지 수납함
        const lettersPool = [
            { title: "[자유부대] 의뢰 관련", body: "다들 잘 지내고 계십니까? 다름이 아니라, 카른의 무너진 사원을 조사해 달라는 요청을 받아서 말입니다. 혹시 관심 있으시다면 회신 부탁드립니다.", sender: "키에르 디트-마루크 드림." },
            { title: "[기타] 사람 찾아요~", body: "에렌빌 씨를 분명 드라바니아 어딘가에서 본 것 같은데 잠깐 두목한테 말하러 간 사이 놓쳤네. 위치 구해요! 잡는 거 도와주면 50만 길.", sender: "카디야❤️" },
            { title: "[자유부대] 긴급!", body: "(편지를 뜯으니 그 안에 편지가 있고 편지를 뜯으니 그 안에 편지가 있다. 마트료시카 편지...) 미안, 시간을 쏟게 하고 싶지는 않았는데 부득이하게 아주 중요한 일이라 이렇게 꽁꽁 묶어서 보내. 정말 크나큰 위기가 다가왔어. 쿠시 생일 때 무슨 선물을 해주는 게 좋을까...? 하아아. 벌써 한 다하고 반이나 고민했는데 아직도 고민중이야. 세랴, 키르. 아무나 조언을 담아서 회신 부탁해. 나, 나는 정말 진지해... 알겠지?", sender: "시프" },
            { title: "[파티] 축제 같이 갈 사람", body: "내일 미케토에서 새로운 축제를 한다고 들었어. 이름이... 대 귀신 강림 축제..? 으, 으음. 할로윈 이벤트라도 하는 걸까 싶은데 귀신이라니 조금 무서워져서. 그치만 궁금하긴 하고... 같이 갈 사람 없을까? 이래놓고 커다란 벌레들이 잔뜩 나오는 공간을 탐험하라고 하면 어떡하지. 겁이 없는 사람 구하고 있어. 부탁할게.", sender: "시프" },
            { title: "[키에르] 키르야 이것 좀 봐 신기하지.", body: "(편지와 함께 토끼모양 머핀이 들어있다. 누굴 참 닮았다.) 아침에 막 구운 건데 아마 이게 도착할 때쯤이면 저녁이겠네. 놀라지 말고 들어야 해. 이거... 귀와 볼에 서로 다른 맛이 나게 되어 있어. 궁금하지 않아? 먹어야 할 것 같지? 응..?", sender: "시프" }
        ];
